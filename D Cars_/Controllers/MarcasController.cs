...
namespace D_Cars_.Controllers
{
    public class MarcasController : Controller
    {
        ...
        public MarcasController(D_CarsContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Precie,Tipo_producto")] Marcas marcas)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Precie,Tipo_producto")] Marcas marcas)
        {
            if (id != marcas.Id)
            {
                return NotFound();
