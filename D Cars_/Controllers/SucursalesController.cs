...
namespace D_Cars_.Controllers
{
    public class SucursalesController : Controller
    {
        ...
        public SucursalesController(D_CarsContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Num_telefono,Direccion")] Sucursales sucursales)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Num_telefono,Direccion")] Sucursales sucursales)
        {
            if (id != sucursales.Id)
            {
                return NotFound();
